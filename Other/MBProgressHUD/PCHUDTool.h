...
#define SHOWERRORHUD(_msg_) [PCHUDTool showCustomViewWithText:_msg_ type:Type_Error inView:[UIApplication sharedApplication].keyWindow]
#define SHOWINFOHUD(_msg_) [PCHUDTool showCustomViewWithText:_msg_ type:Type_Info inView:[UIApplication sharedApplication].keyWindow]
#define SHOWSUCCESSHUD(_msg_) [PCHUDTool showCustomViewWithText:_msg_ type:Type_Success inView:[UIApplication sharedApplication].keyWindow]
#define SHOWTIMEOUTHUD [PCHUDTool showCustomViewWithText:@"连接失败!" type:Type_Error inView:[UIApplication sharedApplication].keyWindow]
